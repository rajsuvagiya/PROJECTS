        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> MANAGEMENT</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: ghraisoni.management@raisoni.net<br>
                ...
                <div class="col-md-6 contacts">
                    ...
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: ghrietn.institute.nagpur@raisoni.net<br>
